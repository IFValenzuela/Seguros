...
const benefits = [
  {
    ...
    description: "Asegura el bienestar económico de tu familia ante cualquier eventualidad.",
  },
  {
    icon: Users,
    title: "Beneficiarios Múltiples",
    description: "Designa a las personas que más importan como beneficiarios de tu póliza.",
  },
  {
    icon: Clock,
    title: "Cobertura de por Vida",
    description: "Planes que te acompañan durante todas las etapas de tu vida.",
  },
]
          ...
          <div className="relative max-w-6xl mx-auto px-6">
            <div className="max-w-2xl">
              ...
              >
                ...
                >
                  Protege el futuro de quienes más amas
                </h1>
                ...
                <p
                  ...
                  style={{ color: "#ebebeb" }}
                >
                  Un seguro de vida es el regalo más valioso que puedes dejar a tu familia.
                  Garantiza su tranquilidad financiera sin importar lo que pase.
                </p>
        ...
        <section className="py-20 md:py-32" style={{ background: "#121212" }}>
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-4">
                  {coverages.map((coverage, i) => (
                    ...
                    >
                      ...
                      <span style={{ color: "#ebebeb" }}>{coverage}</span>
                    </motion.div>
                  ))}
                </div>
              </motion.div>
              ...
              >
                <Image
                  src="https://images.unsplash.com/photo-1516733968668-dbdce39c4651?q=80&w=1000&auto=format&fit=crop"
                  alt="Familia feliz"
                  fill
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            >
              ...
              <p className="text-lg mb-10" style={{ color: "#6B7280" }}>
                Solicita una cotización gratuita y sin compromiso. Nuestros asesores
                te ayudarán a encontrar el plan perfecto para ti.
              </p>
              <Link
                href="/cotizar"
