...
import { Shield, Heart, Stethoscope, Hospital, CheckCircle, ArrowRight, Phone } from "lucide-react"
...
const benefits = [
  {
    ...
    description: "Acceso a los mejores hospitales y clínicas del país con atención de primera clase.",
  },
  {
    icon: Stethoscope,
    title: "Médicos Especialistas",
    description: "Consultas con los mejores especialistas sin largas esperas ni trámites complicados.",
  },
  {
    icon: Heart,
            ...
            <div className="max-w-2xl">
              ...
              >
                ...
                <p
                  ...
                  style={{ color: "#ebebeb" }}
                >
                  Protégete a ti y a tu familia con un seguro de gastos médicos que te brinda
                  acceso a la mejor atención médica cuando más lo necesitas.
                </p>
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            >
              ...
              <p className="text-lg mb-10" style={{ color: "#6B7280" }}>
                Protege tu salud hoy. Solicita una cotización gratuita y descubre
