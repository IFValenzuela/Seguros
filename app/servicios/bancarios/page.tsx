...
import { Landmark, TrendingUp, PiggyBank, CreditCard, CheckCircle, ArrowRight, Phone } from "lucide-react"
...
const benefits = [
  {
    ...
    description: "Haz crecer tu dinero con opciones de inversión seguras y rentables.",
  },
  {
    icon: PiggyBank,
    title: "Ahorro Programado",
    description: "Planes de ahorro diseñados para alcanzar tus metas financieras.",
  },
  {
    icon: CreditCard,
    title: "Créditos Accesibles",
    description: "Financiamiento con las mejores tasas y condiciones del mercado.",
  },
]
...
export default function BancariosPage() {
  return (
          ...
          <div className="relative max-w-6xl mx-auto px-6">
            <div className="max-w-2xl">
              ...
              >
                ...
                >
                  Haz crecer tu patrimonio con confianza
                </h1>
                ...
                <div className="space-y-4">
                  {services.map((service, i) => (
                    ...
                    >
                      ...
                      <span style={{ color: "#ebebeb" }}>{service}</span>
                    </motion.div>
                  ))}
                </div>
              </motion.div>
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            >
              ...
              <p className="text-lg mb-10" style={{ color: "#6B7280" }}>
                Agenda una consulta gratuita con nuestros asesores financieros
                y descubre las mejores opciones para ti.
              </p>
              <Link
                href="/cotizar"
