  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
      ...
      <AnimatePresence>
        {(showTooltip || isHovered) && (
          <motion.div
            ...
            className="bg-white rounded-xl shadow-xl px-4 py-3 max-w-[200px] relative"
          >
            {showTooltip && (
              <button
      ...
      <motion.a
        ...
        className="relative flex items-center justify-center w-14 h-14 md:w-16 md:h-16 rounded-full bg-[#25D366] text-white shadow-lg hover:shadow-xl transition-shadow"
